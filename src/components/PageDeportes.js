...
const url = 'https://backend-mysql-ciclo4-production.up.railway.app/api/deportes'
          ...
          {this.state.data.map(deporte => {
            return(
              <tr key={deporte.dep_id}>
                ...
                <td>{deporte.dep_nombre} <img src={`./icons/${deporte.dep_nombre}.png`} alt="Logo deporte" width={30}></img></td> 
        ...
        <Modal isOpen={this.state.modalInsertar}>
          ...
          <ModalBody>
            <div>
              ...
              <br />
              <label htmlFor="dep_email">Nombre</label>
